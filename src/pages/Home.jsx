...
const Home = () => {
  return (
		<div style={{ width: "100%", height: "100vh", position: "relative" }} id="home">
			<Homenavbar />
			<SoftAurora
				speed={0.6}
				scale={1.5}
				...
				mouseInfluence={0.25}
			/>
			<div className='absolute -translate-x-[50%] -translate-y-[50%] left-1/2 top-1/2 z-10 text-white flex flex-col items-center gap-2'>
